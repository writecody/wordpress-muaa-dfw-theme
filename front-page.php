...
<main>
  <section class="front-page-copy">
    ...
    <p>View the other pages on this site to learn more about our events, the Mizzou Alumni Association, or view our contact information. 
    </p>
    <p>If you need to join or renew your membership, 
      <a class="text-link" href="https://www.mizzou.com/s/1002/alumni/19/membership.aspx?sid=1002&gid=1001&pgid=10097" target="_blank">click here</a>.</p>
    
  </section>
  <section class="front-page-image">
  <img src="<?php echo get_template_directory_uri() ?>/assets/francis-quadrangle.png" />
  </section>
</main>
